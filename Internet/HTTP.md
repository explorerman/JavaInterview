...
![img](HTTP.assets/8441b2c4-dca7-4d6b-8efb-f22efccaf331.png)

### 请求和响应报文

#### 1.请求报文

![img](HTTP.assets/HTTP_RequestMessageExample.png)

#### 2.响应报文

![img](HTTP.assets/HTTP_ResponseMessageExample.png)
...
![img](HTTP.assets/dc00f70e-c5c8-4d20-baf1-2d70014a97e3.jpg)
...
![img](HTTP.assets/HTTP1_x_Connections.png)
...
![img](HTTP.assets/a314bb79-5b18-4e63-a976-3448bffa6f1b.png)



- 而反向代理一般位于内部网络中，用户察觉不到。

![img](HTTP.assets/2d09a847-b854-439c-9198-b29c65810944.png)
...
![img](HTTP.assets/ssl-offloading.jpg)
...
![img](HTTP.assets/7fffa4b8-b36d-471f-ad0c-a88ee763bb76.png)
...
![img](HTTP.assets/39ccb299-ee99-4dd1-b8b4-2f9ec9495cb4.png)

#### 3.HTTPS采用的加密方式

HTTPS 采用混合的加密机制，使用非对称密钥加密用于传输对称密钥来保证传输过程的安全性，之后使用对称密钥加密进行通信来保证通信过程的效率。（下图中的 Session Key 就是对称密钥）

![image-20200902230523798](HTTP.assets/image-20200902230523798.png)

![img](HTTP.assets/How-HTTPS-Works.png)
...
服务器的运营人员向 CA 提出公开密钥的申请，CA 在判明提出申请者的身份之后，会对已申请的公开密钥做数字签名，然后分配这个已签名的公开密钥，并将该公开密钥放入公开密钥证书（又称：数字证书，证书，公钥证书）后绑定在一起。
...
![img](HTTP.assets/2017-06-11-ca.png)
...
![img](HTTP.assets/86e6a91d-a285-447a-9345-c5484b8d0c47.png)
...
![img](HTTP.assets/af198da1-2480-4043-b07f-a3b91a88b815.png)

### 服务器推送

HTTP/2.0 在客户端请求一个资源时，会把相关的资源一起发送给客户端，客户端就不需要再次发起请求了。例如客户端请求 page.html 页面，服务端就把 script.js 和 style.css 等与之相关的资源一起发给客户端。

![img](HTTP.assets/e3f1657c-80fc-4dfa-9643-bf51abd201c6.png)
...
![img](HTTP.assets/_u4E0B_u8F7D.png)
